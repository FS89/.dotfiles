...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(tangotango-theme
                                      all-the-icons)
...
you should place your code here."
  ...
  (add-hook 'python-mode-hook
            (lambda () 
              (local-set-key (kbd "C-.") 'anaconda-mode-find-assignments)
